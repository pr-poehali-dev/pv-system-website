        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between gap-3 text-xs text-[#64748b]">
            ...
            <div className="flex gap-4">
              <a href="https://cdn.poehali.dev/projects/70a8d357-1c4f-4d1c-9bc4-9ce5ff1444a9/bucket/cb9cf69b-61fe-486f-8d29-59440cf3ff71.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Сертификат соответствия</a>
