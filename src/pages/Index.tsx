...
const MODULES = [
  ...
  { icon: "Flame", code: "ГАЗ-01", title: "Газовый баланс", desc: "Расчёт поступления CH₄, CO, CO₂, NO₂ и H₂S. Разбавление до ПДК по ФНП в угольных шахтах и рудниках" },
...
const ADVANTAGES = [
  ...
  { num: "15", label: "Лет на рынке", sub: "инженерного ПО для шахт" },
  { num: "8", label: "Расчётных модулей", sub: "в одном комплексе" },
  { num: "100%", label: "Соответствие ФНП", sub: "актуальная нормативная база" },
];
...
const CASES = [
  {
    ...
    result: "Повышение расхода воздуха на 23%, устранение метановых пиков",
    img: IMG_AERIAL,
  },
  {
    ...
    result: "Снижение затрат на кондиционирование на 31%",
    img: IMG_MINE,
  },
  {
    ...
    depth: "340 м",
    task: "Разработка ПЛА с моделированием аварийного проветривания и реверса",
              ...
              {vr ? (
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-xs text-[#5a6e82] bg-[#e8f4fd] rounded p-3 border-l-3 border-[#0e63b0]" style={{ borderLeft: "3px solid #0e63b0" }}>
                      Расчёт по РД 06-356-00. Нормы: до 4 м/с в тупиковых, до 8 м/с в сквозных выработках.
                    </div>
                  </div>
                </div>
              ) : (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-[#0e63b0] rounded-lg p-4">
                      ...
                      <div className="text-xs text-green-300 font-semibold mt-1">✓ ПДК по CH₄ обеспечено</div>
                    </div>
                  </div>
                </div>
              ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#bfdbfe] text-lg leading-relaxed mb-3 max-w-lg anim-2">
                Расчёт вентиляции шахт и рудников, шахтного водоснабжения и водоотлива.
                Соответствие ФНП, ПБ 05-618-03 и требованиям Ростехнадзора.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#5a6e82] leading-relaxed mb-5">
                ПВ-Система — программный комплекс для расчёта вентиляции и водоснабжения шахт и рудников. Разработан совместно с ВНИМИ и Санкт-Петербургским горным университетом. В основе — метод Харди–Кросса и актуализированная нормативная база Ростехнадзора.
              </p>
              <p className="text-[#5a6e82] leading-relaxed mb-8">
                В отличие от универсального САПР, система ориентирована исключительно на подземные горные выработки: корректно обрабатывает схемы с рециркуляцией, аварийным реверсом и ВМП. Формирует проектную документацию, принимаемую Ростехнадзором.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                {[
                  "Метод Харди–Кросса (до 10⁻⁶ точность)",
                  "Схемы с рециркуляцией воздуха",
                  "Расчёт реверса вентиляции для ПЛА",
                  "Протоколы для Ростехнадзора",
              ...
              <div className="flex items-center gap-3 p-4 bg-[#f0f7ff] rounded-lg border border-[#bee3f8]">
                ...
                <div>
                  ...
                  <div className="text-xs text-[#5a6e82]">Свидетельство о регистрации программы для ЭВМ · Роспатент</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-[#94a3b8] leading-relaxed max-w-xs">
                Программный комплекс для расчёта вентиляции шахт и рудников. Внесён в Реестр отечественного ПО МинЦифры РФ.
              </p>
            </div>
            <div>
